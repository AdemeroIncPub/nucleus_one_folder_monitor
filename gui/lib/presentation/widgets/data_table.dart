...
//
//
// TODO(apn): This whole file will hopefully go away sooner than later,
// https://github.com/flutter/flutter/pull/112733
//
//
//
...
class DataTable extends StatelessWidget {
  ...
  DataTable({
    ...
    this.border,
        ...
        assert(expandColumnIndex == null ||
            (expandColumnIndex >= 0 && expandColumnIndex < columns.length)),
  ...
  static int? _initOnlyFlexColumn(
